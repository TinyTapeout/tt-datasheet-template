...
The following Wokwi project demonstrates this setup: #link("https://wokwi.com/projects/36434780766")[wokwi.com/projects/36434780766]. It contains an Arduino Nano that decodes the currently selected mux address and displays it on a
7-segment display. Click on the button labeled `RST_N` to reset the counter, and click on the button labeled `INC` to
